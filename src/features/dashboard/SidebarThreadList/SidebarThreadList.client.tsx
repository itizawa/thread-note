...
type SidebarThreadListClientProps = {
  initialData: inferRouterOutputs<AppRouter>["thread"]["listThreadsByCurrentUser"];
};

export function SidebarThreadListClient({
  initialData,
}: SidebarThreadListClientProps) {
  ...
  return (
    <>
      <Link href={urls.dashboardThreadDetails(thread.id)} className="">
        <div className="flex items-center justify-between rounded-lg p-2 hover:bg-gray-300 group">
